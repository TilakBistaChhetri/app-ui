...
body:Stack(
  ...
  children: [
    ...
    SizedBox(height:25),
    Center(child:Text("Create Your Profile", style:TextStyle(fontSize:25,fontWeight:FontWeight.bold)),
    ),
     SizedBox(height:25),
    Center(child:Text("Complete your profile to help you find by", style:TextStyle(fontSize:19)),
    ),
     SizedBox(height:1),
    Center(child:Text("Delivery boy who will be right for you.", style:TextStyle(fontSize:19)),
    ),
